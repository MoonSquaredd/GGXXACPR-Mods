This repository conatins all my DLL mods for *Guilty Gear XX Accent Core Plus R* on Steam. All of them require [Gear Loader](https://github.com/YouKnow232/GearLoader) in order to work. For more details on each mod, refer to their respective READMEs.
...
* **Bad Apple** <small>( [Gamebanana](https://gamebanana.com/mods/694316) | [Source](BadApple) )</small>
_Plays Bad Apple through the game's sprite system._

* **1/10000 chance of getting jumpscared by foxy** <small>( [Gamebanana](https://gamebanana.com/mods/631335) | [Source](FoxyJumpscare) )</small>
_Every in-game second there is a 1/10000 chance of you getting jumpscared by withered foxy._
...
_Readds Korea from GGXX#Reload to the game and enables it to be selected in stage selection._

* **Slash Character Select** <small>( [Gamebanana](https://gamebanana.com/mods/629125) | [Source](SlashSelect) )</small>
_Makes the game use GGXX Slash character select instead of the AC one._
---
### WIPs
<small>Mods still in the making.</small>
* **Corner Goobers** <small>( [Source](CornerGoobers) )</small>
_Attempts to restore the HUD character mirrors from #Reload._
...
_Tons of debug related stuff. Intended to aid further modding development._
---
This README was inspired by the one @ [StardewMods by Pathoschild](https://github.com/Pathoschild/StardewMods)
